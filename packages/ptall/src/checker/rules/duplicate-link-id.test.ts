...
`,
    ...
    workspace.addDocument(
      `2026-01-05T18:00 create lore "Second entry" ^my-link #test
  type: insight
`,
  ...
  it("reports duplicate explicit link IDs across files", () => {
    workspace.addDocument(
      `2026-01-05T17:00 create lore "First entry" ^shared-id #test
  type: fact
`,
      { filename: "file1.ptall" },
    );
    ...
    workspace.addDocument(
      `2026-01-05T18:00 create lore "Second entry" ^shared-id #test
  type: insight
`,
      { filename: "file2.ptall" },
    );
  ...
  it("does not report unique link IDs", () => {
    workspace.addDocument(
      `2026-01-05T17:00 create lore "First entry" ^link-1 #test
  type: fact

2026-01-05T18:00 create lore "Second entry" ^link-2 #test
  type: insight
`,
      { filename: "test.ptall" },
    );
...
`,
  ...
  it("reports all instances of duplicate IDs across files", () => {
    workspace.addDocument(
      `2026-01-05T17:00 create lore "First" ^dup #test
  type: fact
`,
      { filename: "file1.ptall" },
    );
    ...
    workspace.addDocument(
      `2026-01-05T18:00 create lore "Second" ^dup #test
  type: insight
`,
      { filename: "file2.ptall" },
    );
    ...
    workspace.addDocument(
      `2026-01-05T19:00 create lore "Third" ^dup #test
  type: fact
`,
