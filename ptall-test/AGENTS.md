# PTALL - Personal Thought And Lore Language
...
Metadata fields are indented key-value pairs. See `entities.ptall` for required/optional fields per
entity. Values can be:
