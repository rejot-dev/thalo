...
import { DemoProvider, type DemoStep } from "@/components/demo/demo-context";
import { DemoPanel, PanelCode, syn } from "@/components/demo/demo-panel";
...
function StickyControls() {
  const { currentStep, totalSteps, steps, step, goToStep, nextStep, prevStep } = useDemo();
