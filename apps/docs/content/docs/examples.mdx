...
2026-01-08T14:30Z create opinion "Premature abstraction is worse than duplication" ^opinion-abstraction #programming #architecture
  ...
  wrong assumptions - Changing a wrong abstraction is harder than merging duplicated code - The Rule
  of Three exists for a reason: wait for the third instance
