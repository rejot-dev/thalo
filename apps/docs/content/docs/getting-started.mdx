...
```npm
npx skills add https://github.com/rejot-dev/thalo
```

Next, ask your agent to initialize a project.
...
2026-01-08T14:30Z create opinion "Plain text is powerful" ^first-opinion #pkm
  ...
  # Reasoning
  - Works with any tool - Version control friendly - Human and machine readable
```
